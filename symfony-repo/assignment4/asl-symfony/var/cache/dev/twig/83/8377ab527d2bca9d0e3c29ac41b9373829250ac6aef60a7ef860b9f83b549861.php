...
/* home.html.twig */
class __TwigTemplate_ae55b302296d6cda09f58377272e6313830738b255e2c2bdbc015a9cd331fd08 extends Twig_Template
{
    private $source;
...
<html>
    ...
    <h1>";
        // line 11
        echo twig_escape_filter($this->env, (isset($context["page"]) || array_key_exists("page", $context) ? $context["page"] : (function () { throw new Twig_Error_Runtime('Variable "page" does not exist.', 11, $this->source); })()), "html", null, true);
        echo "</h1>
    <br>
    <h4>";
        // line 13
        echo twig_escape_filter($this->env, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new Twig_Error_Runtime('Variable "message" does not exist.', 13, $this->source); })()), "html", null, true);
        echo "</h4>

    ";
        // line 15
        $this->loadTemplate("bs-scripts.html.twig", "home.html.twig", 15)->display($context);
        // line 16
        echo "    </body>
</html>
...
";
    ...
    {
        return array (  59 => 16,  57 => 15,  52 => 13,  47 => 11,  43 => 9,  41 => 8,  37 => 6,  35 => 5,  29 => 1,);
    }
...
", "home.html.twig", "/Users/tobyhorn/Documents/asl/asl/symfony-repo/assignment1/asl-symfony/templates/home.html.twig");
    }
}
