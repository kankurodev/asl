...
/* profile.html.twig */
class __TwigTemplate_5aa8b7d2fe9aa60bdffdedc670a9049ff515a8b3ef540e9d3d1df854bde71bf1 extends Twig_Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        if (array_key_exists("user", $context)) {
            // line 5
            echo "        <h1>Hello ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 5, $this->source); })()), "name", array()), "html", null, true);
            echo "!</h1>
        <br>
        <img src=\"";
            // line 7
    ...
    ";
            ...
            <p class=\"h4 mb-0\">Error: User does not exist!</p>
        </div>
    ";
        }
...
{% block body %}
    ...
    {% endif %}
{% endblock %}", "profile.html.twig", "/Users/tobyhorn/Documents/asl/asl/symfony-repo/assignment4/symfony-api/templates/profile.html.twig");
    }
}
